      ...
      <div class="flex gap-16">
        <div>
          ...
          <div class="flex items-center mt-4">
            <label class="relative inline-block">
              ...
              />
              <span
                class="relative inline-block bg-neutral-700 outline-none filter-form__select py-1.5 px-2.5 rounded mr-5"
                >Выберите файл
              </span>
              <span class="input-file-text">Загрузить изображение</span>
            </label>
        ...
        <div class="flex flex-col gap-3">
          ...
          <div class="flex items-center">
            ...
            />
            <button
              class="flex justify-center items-center btn bg-violet-900 h-10 w-10 btn-block rounded-r-lg border border-black border-solid"
            >
              <svg
                width="19"
                height="18"
          ...
          <div class="flex gap-1">
            <div class="flex items-center">
              <span
                class="flex items-center text-xs h-[38px] bg-neutral-800 border border-r-[0px] border-black border-solid px-2 rounded-l-lg"
              >
                Куриное яйцо
              </span>
              <button
                class="flex justify-center items-center btn bg-neutral-900 h-[38px] w-10 btn-block rounded-r-lg border border-black border-solid"
              >
                <svg
                  width="25"
                  height="24"
                ...
                >
                  <path
                    ...
                    fill="#808080"
                    class="hover:fill-current hover:fill-white"
                  />
                  <path
          ...
          <textarea
            class="outline-none bg-neutral-800 h-20 w-[430px] rounded-lg border border-black border-solid placeholder-gray-600 px-4 py-1 transition-all ease-in focus:border-neutral-700"
            placeholder="Введите описание"
          ></textarea>
          <div class="flex items-center gap-5">
            <p class="font-bold">Время приготовления</p>
            <select
